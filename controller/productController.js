...
var gateway = new braintree.BraintreeGateway({
  ...
  // merchantId: 'gnhp6gkkytgvrpfp',
  // publicKey: 'hpfhpxksds2d542x',
  // privateKey: 'a5baabc147b2d4c91d1d0f52458961d3',
});
  ...
  try {
    ...
    switch (true) {
      ...
      case photo && photo.size > 100000:
        return res
          .status(500)
          .send({ error: "Photo is requires and should be less than 1MB" });
    }
    ...
    return res.status(500).send({
      success: false,
      err,
      message: "Error at Create Product Controller",
    });
  }
};
...
export const getProductController = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      err,
      message: "Error at get product controller",
    });
  }
};
...
export const singleProductController = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      err,
      message: "Error at single-product Controller",
    });
  }
};
...
export const productPhotoController = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      err,
      message: "Error at product photo controller",
    });
  }
};
...
export const deleteProductController = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      err,
      message: "Error at Delete product Cotroller",
    });
  }
};
...
export const updateProductController = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      err,
      message: "Error at Update product Cotroller",
    });
  }
};
...
export const productsFilterController = async (req, res) => {
  try {
    ...
    return res.status(400).send({
      success: false,
      message: "Error at product filter controller",
      err,
    });
  }
};
...
export const productCountController = async (req, res) => {
  try {
    ...
    return res.status(400).send({
      success: false,
      message: "Error at product count",
      err,
    });
  }
};
...
export const searchProductController = async (req, res) => {
  try {
    ...
    return res.status(400).send({
      success: false,
      message: "Error at search product",
      err,
    });
  }
};
...
export const productCategoryController = async (req, res) => {
  try {
    ...
    return res.status(400).send({
      success: false,
      message: "Error at Product category controller",
      err,
    });
  }
};

export const brainreeTokenController = async(req, res) => {
  try {
    await gateway.clientToken.generate({}, function(err, response) {
      if (err) {
        res.status(500).send({
          success: false,
          message: "Error at braintree gateway"
        });
        console.log(err)
      } else {
        res.send(response);
